...
Для подсчета производительности каждой версии сравнивалось время работы `100` циклов полного заполнения хэш-таблицы - около 500 000 элементов (версии insert), и поиска - около 100 000 элементов (версии search) через **rdtsc**. Для большей точности и воспроизводимости вычислений программа исполнялась на одном ядре (см. [pin_to_core](src/unit_testing.cpp)) в отсутвие других запущенных приложений (только VS Code).
