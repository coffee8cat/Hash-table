...
Хэш таблица - структура данных, которая позволяет осуществлять доступ к элементу по его ключу. Первый этап доступа к элементу хэш-таблицы - вызов хэш-функции, отображающей множество ключей в множество индексов массива элементов хэш-таблицы. Однако, ввиду ограниченности числа хэш-значений (множества значений хэш-функции) возможны `коллизии` - различные ключи, дающие одинаковые хэш-значения. Для разрешения коллизий существует несколько методов:
...
<div align="center">
  <img src="img/open-addressing.png" alt="picture" width="500" />
</div>
...
<div align="center">
  <img src="img/chain-addressing.png" alt="picture" width="500" />
</div>
...
- **Model**: Laptop HP PAVILLION GAMING 15 ec1078ur
...
![picture](img/perf_list_search.png)

На втором месте после list_search по-прежнему идет strncmp. Займемся ею.

Примем во внимание, что слова в нашем тексте занимают не более 32 символов каждое, поэтому можно проводить сравнение строк, используя SIMD инструкции с ymm регистрами.


<details open>
<summary>Код str32cmp</summary>
...
![picture](img/perf_strcmp.png)

</details>

Порядок функций не поменялся, но первые две уже оптимизированы. Следующей идет crc32.
